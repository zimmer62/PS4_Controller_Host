...
ps4_analog_stick_t parsePacketAnalogStick(uint8_t* packet) {
  ...
  if (packet[packet_index_analog_stick_lx] == 0) ps4AnalogStick.lx = minJ;
  else ps4AnalogStick.lx = packet[packet_index_analog_stick_lx] + offset;
  if (packet[packet_index_analog_stick_ly] == 0) ps4AnalogStick.ly = minJ;
  else ps4AnalogStick.ly = packet[packet_index_analog_stick_ly] + offset;
  if (packet[packet_index_analog_stick_rx] == 0) ps4AnalogStick.rx = minJ;
